...
class EccFactory
{
     ...
     * @return \Wangjunasd\Ecc\Math\NumberTheory
     */
     ...
     * @param  int|string           $b
     * @param  MathAdapterInterface $adapter [optional] Defaults to the return value of EccFactory::getAdapter().
     * @return \Wangjunasd\Ecc\Primitives\CurveFpInterface
     */
     ...
     *
     * @param  MathAdapterInterface $adapter [optional] Defaults to the return value of EccFactory::getAdapteR()
     * @return \Wangjunasd\Ecc\Crypto\Signature\Signer;
