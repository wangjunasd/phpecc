...
class DerPrivateKeySerializer implements PrivateKeySerializerInterface
{
    ...
    /**
     * @var \Wangjunasd\Ecc\Math\DebugDecorator|MathAdapterInterface|null
     */
    private $adapter;
    ...
    /**
     * {@inheritDoc}
     * @see \Wangjunasd\Ecc\Serializer\PrivateKeySerializerInterface::serialize()
     */
     ...
     * @param string $data
     * {@inheritDoc}
     * @see \Wangjunasd\Ecc\Serializer\PrivateKeySerializerInterface::parse()
